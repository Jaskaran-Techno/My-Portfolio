        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+91 7668126996'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'developer.micko@gmail.com'}  title={'Email'}/>
                    <ContactItem icon={location} text1={'Modinagar, Uttar Pradesh'} text2={'India'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
